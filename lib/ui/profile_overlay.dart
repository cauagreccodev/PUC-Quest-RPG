...
class ProfileOverlay extends StatelessWidget {
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                ...
                                const SizedBox(height: 14),
                                _buildConsumablesCard(playerState),
                              ],
                            ),
                          ),
                        ),
  ...
  Widget _buildInventoryCard(PlayerStateModel playerState) {
    final items = playerState.inventory.where((i) => i.id.startsWith('key_')).toList();
    return _MedievalCard(
      title: '🔑  ITENS CHAVE',
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Text(
                      'Nenhum item chave encontrado.\nExplore as terras e derrote os chefes!',
  ...
  Widget _buildConsumablesCard(PlayerStateModel playerState) {
    final items = playerState.inventory.where((i) => !i.id.startsWith('key_')).toList();
    return _MedievalCard(
      title: '🎒  ITENS',
      titleColor: MedievalColors.parchmentDark,
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 10),
                    const Text(
                      'Sua mochila está vazia.\nVocê precisa de itens para sobreviver!',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: MedievalColors.textMuted,
                        fontSize: 13,
